  ...
  <div className="social-sharing" style={ under ? style : {} }>
      ...
      <div>
       <TwitterShareButton style={{ width: '32px', height:'32px' }}
         url={`https://cookblog.vercel.app/posts/${slug}`} >
        ...
        renderNode: {
          [BLOCKS.EMBEDDED_ASSET]: node => {
            ...
            switch (mimeGroup) {
              case 'image':
                return <span>
                  <img className="responsive-image" title={title ? title['en-US'] : null} alt={desc ? desc['en-US'] : description} src={proxyUrl} />
                  {
      ...
      <div className='blog-parent-section'>
        ...
        <div className='post-container'>
          ...
          <div className='blog-main' style={{ width: windowWidth < 1000 ? '100%' : '50%' }}>
            ...
            {
              windowWidth < 1000 ? <SocialSharing slug={post.slug} under={true} /> : ''
            }

          </div>

          {
            windowWidth > 1000 ? <SocialSharing slug={post.slug} under={false} /> : ''
          }
